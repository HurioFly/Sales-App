        ...
        buttonPayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(userName)) {
                    ...
                    compositeDisposable.add(apiSalesApp.createOrder(Utils.user.getPhoneNumber(), userName, address, phoneNumber, currentTime.toString(), totalPayment, paymentMethods, new Gson().toJson(Utils.productsToBuy))
